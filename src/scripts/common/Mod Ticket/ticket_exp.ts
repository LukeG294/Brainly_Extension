    ...
    <h1 class="sg-text-bit--gray-secondary sg-headline sg-headline--xlarge sg-headline--extra-bold" style = "color:#323c45; margin-bottom:8px;">Question Content</h1>
      ...
      <div class = "preview-content">
        ...
        <h1 class="sg-text-bit sg-text-bit--small sg-text-bit--peach-primary" style="display: flex;justify-content: center;line-height: 1.2rem;font-size: 1rem;color: #c3d1dd;align-items: center;">question</h1>
          ...
          <div class="qdata">
            <div class="user-info">
            <div class="brn-element-wrapper ptsbox" style = "position: absolute; right:16px;"><div data-testid="tooltip_container" class="Tooltip-module__brn-tooltip-container--tq9gl"><div role="button" class="Tooltip-module__brn-tooltip-children--2gl8t" tabindex="0" aria-haspopup="true" aria-expanded="false"><div data-testid="points_counter" class="sg-counter sg-counter--xs sg-counter--red-50 sg-counter--with-icon"><div class="sg-flex sg-counter__icon-container"><div class="sg-icon sg-icon--icon-black sg-icon--x24 sg-counter__icon"><svg class="sg-icon__svg" role="img" aria-labelledby="title-points-2eu2rg" focusable="false"><text id="title-points-2eu2rg" hidden="">points</text><use xlink:href="#icon-points" aria-hidden="true"></use></svg></div></div><div class="sg-flex sg-flex--align-items-center"><span class="sg-text sg-text--small sg-text--bold sg-counter__text"><span class="sg-text sg-text--text-gray-60 sg-text--small sg-text--bold sg-text--no-wrap"><span class="sg-text sg-text--small sg-text--bold text-points">+5</span> pts</span></span></div></div></div></div></div>
