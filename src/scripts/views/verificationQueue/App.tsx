        ...
        <>
            ...
            <div className="content">
                <div className="menu">
                    ...
                    <Button type='solid' className={"outerButtonSwitcher"} onClick={() => verificationSwitcherHandler(setItems)}> <Dropdown name={"Verification"} links={[{'label':'Verification','url':'repl-this-verify'},{'label':'Coming Soon','url':'repl-this-unverify'}]}></Dropdown></Button>
                </div>
