...
export default new class BasicFn{
    ...
    selectAll(){
        this.buttonArea.insertAdjacentHTML('afterend', select_all())
    ...
    copyLinks() {
        this.buttonArea.insertAdjacentHTML('afterend', copy_links())
    ...
    toggleSelection() {
        this.buttonArea.insertAdjacentHTML('afterend', toggle_selected())
